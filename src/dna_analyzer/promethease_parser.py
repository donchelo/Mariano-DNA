...
# -*- coding: utf-8 -*-
"""
Módulo para convertir el reporte de texto de Promethease a formato JSON estructurado.
"""
...
def load_promethease_json(json_file: str) -> List[Dict[str, Any]]:
    """
    Carga un archivo JSON de hallazgos genéticos de Promethease.
    
    Args:
        json_file: Ruta al archivo JSON
        
    Returns:
        Lista de entradas genéticas
    """
...
if __name__ == '__main__':
    input_file = 'promethease/prometheus txt.txt'
    output_file = 'promethease/hallazgos_geneticos.json'
    
    try:
        parse_genetic_data(input_file, output_file)
